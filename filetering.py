...
# CSV 파일 읽기
input_file = 'store_info.csv'  # 입력 파일 경로
output_file = 'filtered_output.csv'  # 출력 파일 경로
...
filtered_df = filtered_df[filtered_df['도로명주소'].str.contains('신촌|대흥로|광성로|와우산로|신수로|백범로', na=False)]
